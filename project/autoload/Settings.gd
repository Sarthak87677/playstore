...
const PRESET_DATA := [
	{   # LOW
		...
		"terrain_res": 0.70, "cloud_steps": 0, "post_quality": 0.0, "shadow_blur": 1.4, "parallax": 0.0,
	...
	{   # MEDIUM
		...
		"terrain_res": 0.85, "cloud_steps": 6, "post_quality": 0.7, "shadow_blur": 1.1, "parallax": 0.0,
	...
	{   # HIGH
		...
		"terrain_res": 1.0, "cloud_steps": 11, "post_quality": 1.0, "shadow_blur": 0.85, "parallax": 0.6,
	...
	{   # CINEMATIC
		...
		"terrain_res": 1.25, "cloud_steps": 18, "post_quality": 1.15, "shadow_blur": 0.7, "parallax": 1.0,
